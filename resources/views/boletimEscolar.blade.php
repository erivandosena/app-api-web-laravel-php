    ...
    <div class="container-fluid">
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
                ...
                <div class="card">
                    <div class="card-header">{{ __('Boletim de Notas Escolares') }}</div>
                    <div class="card-body">
                        ...
                        <a href="{{ route('listaAlunos', $dados[0]->cod_esco) }}" class="btn btn-xs btn-info pull-right">Lista Geral de Alunos</a>
                        @endif
                    </div>
                </div>
